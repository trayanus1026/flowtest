...
Write-Host "Please run manually: psql flowtest -f src/database/rls-setup.sql" -ForegroundColor Yellow
...
Write-Host "2. Set up JWT_SECRET in .env" -ForegroundColor Yellow
